...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Military model.airport sorted by max distance: " + militaryAirport
                .sortByMaxDistance()
                .toString());
        System.out.println("Passenger model.airport sorted by max speed: " + passengerAirport
                .sortByMaxSpeed()
                .toString());
